...
class CPlot3dDocTemplate : public CSingleDocTemplate
{
	DECLARE_DYNAMIC(CPlot3dDocTemplate)

	CPlot3dDocTemplate(UINT nIDResource,
...
// Overrides
	...
	//{{AFX_VIRTUAL(CPlot3dDocTemplate)
	//}}AFX_VIRTUAL

// Implementation
protected:
	virtual ~CPlot3dDocTemplate();

	// Generated message map functions
	//{{AFX_MSG(CPlot3dDocTemplate)

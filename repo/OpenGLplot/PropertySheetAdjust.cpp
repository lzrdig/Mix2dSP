...
LRESULT CPropertySheetAdjust::OnAdjustPropertySheet(WPARAM wParam, LPARAM lParam) 
{
...
void CPropertySheetAdjust::Adjust()
{
	...
	if (!m_bRcModifiedIsUpToDate && IsWizard())
	{
		dx = -rectReal.left;
		dy = -rectReal.top;

...
void AFXAPI DDX_TextNMB(CDataExchange* pDX, int nIDC, float& value)
{
	AfxTextFloatFormatNMB(pDX, nIDC, &value, value, FLT_DIG);
}

void AFXAPI DDX_TextNMB(CDataExchange* pDX, int nIDC, double& value)
{
	AfxTextFloatFormatNMB(pDX, nIDC, &value, value, DBL_DIG);
}
...
void AFXAPI DDX_TextComma2(CDataExchange* pDX, int nIDC, double& value)
{
	AfxTextFloatFormatComma(pDX, nIDC, &value, value, DBL_DIG+1);
}
